...
format: html
lightbox: auto
notion_id: c01e51da-4929-4d72-ad3b-6b90d7d96617
notion_url: https://www.notion.so/The-Components-of-a-Personal-Knowledge-Management-c01e51da49294d72ad3b6b90d7d96617
...
---
![](images/pkm_components/The_Components_of_a_Personal_Knowledge_Management-6bf1a93d980.png)
...
![](images/pkm_components/The_Components_of_a_Personal_Knowledge_Management-e5352d24449.png)
...
![](images/pkm_components/The_Components_of_a_Personal_Knowledge_Management-4cc6496d691.png)
...
![](images/pkm_components/The_Components_of_a_Personal_Knowledge_Management-ba3a3016f15.png)
...
![](images/pkm_components/The_Components_of_a_Personal_Knowledge_Management-63fd62d11fd.png)
...
![](images/pkm_components/The_Components_of_a_Personal_Knowledge_Management-5cf51abe08d.png)
...
Now, let\'s dive right into the realm of structured consumption from a Personal Knowledge Management (PKM) system. You know when you neatly categorize and organize information, much like the systematic arrangement of books in a library? That\'s structured consumption. Structured consumption taps into methods such as Filtering, Retrieving, Correlating, Searching, and Plotting. Allow me to walk you through it.

Filtering is like having a personal librarian who knows exactly what books you want read. Within a structured PKM, you format data in a way that lets you filter out irrelevant information. When we\'re talking about retrieving information, think of it as a real-time, personalized book recommendation engine that fetches specific data points relevant to your query -- basically, your librarian friend again. And when you correlate, that\'s your librarian cross-referencing genres, authors, or publication years to predict your next best read based on your reading history. Are you seeing a pattern here?

Search and Plot functions can be best visualised as magic spells that can summon any book at your command, and a literal plot generator, respectively. Now, where does AI tie into this neatly-bound package? Well, AI makes the \"librarian\" work efficiently. It brings in Machine Learning to predict, understand, and improve the retrieval of data, thereby saving your time and effort.

### Unstructured

Shifting gears to unstructured consumption, we\'re now dealing with a dynamic, fluid structure, much like an ever-changing story. In unstructured consumption, we focus on Summarizing, Expanding, Augmenting, and Attributing information. Imagine an AI entity summarizing a book for you, or expanding upon a cliffhanger. Isn\'t that exciting?

The Augment function could be like your personal AI fanfiction writer, relating and adding extra layers to your favorite storylines. Attribution might resemble an outspoken critic, finding sources and attributing credit wherever necessary. This shifting, evolving nature of unstructured consumption requires more creative AI solutions, such as Natural Language Processing, to dissect, understand, and maneuver text, and in turn, provide you with a rich, unstructured, yet organized consumption experience.
