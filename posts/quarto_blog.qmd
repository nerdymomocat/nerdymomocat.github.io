...
💡 **Searching for options**
	- Examples
		...
		[https://ddimmery.com/](https://ddimmery.com/)
		[https://quartz.jzhao.xyz/](https://quartz.jzhao.xyz/)
		[https://albert-rapp.de/blog.html](https://albert-rapp.de/blog.html)
		[https://wasimlorgat.com/](https://wasimlorgat.com/)
	- Softwares
		[//]: # (link_preview is not supported)
		[https://quarto.org/](https://quarto.org/)
		- Resources
			[https://mine-cetinkaya-rundel.github.io/quarto-tip-a-day/](https://mine-cetinkaya-rundel.github.io/quarto-tip-a-day/)
			[https://github.com/ivelasq/pipedream/blob/main/custom.ejs](https://github.com/ivelasq/pipedream/blob/main/custom.ejs)
			[//]: # (link_preview is not supported)
			- Quarto Extensions
				[//]: # (link_preview is not supported)
				[//]: # (link_preview is not supported)
				...
				[//]: # (link_preview is not supported)
			- Quick References
				Get icons from: [https://icons.getbootstrap.com/](https://icons.getbootstrap.com/)
		[//]: # (link_preview is not supported)
		[//]: # (link_preview is not supported)
		[https://simply-jekyll.netlify.app/](https://simply-jekyll.netlify.app/)
		- Resources
			[//]: # (Synced Block)
				[//]: # (link_preview is not supported)
		[//]: # (link_preview is not supported)
...
7. Modify basic configuration:
	8. Replace `favicon.ico` by the icon you want to use for your website.
	9. Modify `index.qmd`
```markdown
---
listing:
